...
export function AuthPage({ mode, onBack, onToggleMode }: AuthPageProps) {
  ...
  const handleGoogleLogin = async () => {
    ...
    // If there's an error the redirect never happens — clear loading and show it.
    // If there's no error the browser navigates away; loading state resolves on remount.
    if (error) {
